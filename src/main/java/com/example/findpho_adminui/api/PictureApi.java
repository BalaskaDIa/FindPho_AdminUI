...
public class PictureApi  extends Controller {
    ...
    public static Picture postPicture(Picture newPicture) throws IOException {
        Gson jsonConvert = new Gson();
        String pictureJson = jsonConvert.toJson(newPicture);
        Response response = RequestHandler.post(PICTURE_API_URL, pictureJson);
